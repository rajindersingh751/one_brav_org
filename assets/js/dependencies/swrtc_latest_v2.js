  ...
  return function e(t, n, r) {
    ...
    101: [function (e, t, n) {
      function r(e) {
        ...
        this.capabilities = a, o.call(this), n = null === this.config.connection ? this.connection = new d(this.config) : this.connection = this.config.connection,

          n.on("connect", function () {
            console.log('CONNECT_OK = SESSION_READY')
      ...
      r.prototype = Object.create(o.prototype, {
        ...
        r.prototype.joinRoom = function (e, t) {          
          ...
          this.connection.emit("join", e, function (r, i) {
            if (console.log("join CB", r, i), r) n.emit("error", r);
              ...
              console.log("Outside join cb error")
              var o, a, s, c;
              for (o in i.clients) {
                a = i.clients[o];
            ...
            t && t(r, i), n.emit("joinedRoom", e.name)
          })
        },

        /** Custom brav Emmitter 1 */
        r.prototype.bravMessage = function (m, cb) {
          this.connection.emit('brav_message', m, function (er, response) {
            if (cb) cb(response);
          });
        }
        /** Custom brav Emmitter Ends*/
        ...
        /*r.prototype.createRoom=function(e,t){
          ...
          this.roomName=e.name,2===arguments.length?this.connection.emit("create",e,t):this.connection.emit("create",e)},
        */
    ...
    102: [function (e, t, n) {
      function r(e) {
        console.log('Vatsal : In Socket url ' , e);
